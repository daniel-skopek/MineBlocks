...
import cz.raixo.blocks.util.color.patterns.GradientPattern;
import cz.raixo.blocks.util.color.patterns.Pattern;
import cz.raixo.blocks.util.color.patterns.RainbowPattern;
import cz.raixo.blocks.util.color.patterns.SolidPattern;
